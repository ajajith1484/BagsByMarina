  ...
  return (
    <section className="relative h-[80vh] min-h-[600px] flex items-center overflow-hidden">
      ...
      <div className="relative z-20 max-w-[600px] px-8 md:px-24">
        <p className="text-[0.75rem] tracking-[0.15em] uppercase text-white/90 md:text-marina-light mb-8 font-medium">
          DELHI, INDIA · PAN INDIA SHIPPING · MADE TO ORDER
        </p>
        <h2 className="font-playfair text-[clamp(2.5rem,5vw,4.5rem)] leading-[1.1] font-medium mb-8 text-white md:text-black">
          Your Style,<br />Your Bag.
        </h2>
        <p className="text-[1.1rem] text-white/90 md:text-marina-light mb-16 max-w-[400px]">
